...
public class Corvette extends Ship implements Serializable{
	...
	public Corvette(int shipId, int shipBelongsToPlayer, int xCord, int yCord, boolean isHorizontal) {
		super(shipId, shipBelongsToPlayer, 3, 1, 1, "C", xCord, yCord, isHorizontal, false, true, 3, 1);
	}
}
